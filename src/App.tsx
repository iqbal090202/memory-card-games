...
function App() {
  const [showUnsuccessful, setShowUnsuccessful] = useState<undefined | string>(
    undefined
  );
  ...
  return (
    <div style={styles.container}>
        ...
        <>
          ...
          <div style={styles.chooseContainer}>
            <span
              ...
              style={styles.chooseGridButton}
            >
              4x4
            </span>
            <span
              onClick={() => setGridNumber(5)}
              style={styles.chooseGridButton}
            >
              4x5
            </span>
            <span
              onClick={() => setGridNumber(6)}
              style={styles.chooseGridButton}
            >
              4x6
            </span>
      ...
      {gridNumber > 0 && !showUnsuccessful && (
        <div>
          <h2>Show unsuccessful attempts?</h2>
          <div style={styles.chooseContainer}>
            <span
              onClick={() => setShowUnsuccessful("yes")}
              style={styles.chooseGridButton}
            >
              Yes
            </span>
            <span
              onClick={() => setShowUnsuccessful("no")}
              style={styles.chooseGridButton}
            >
              No
            </span>
      ...
      {showUnsuccessful === "yes" && (
        <div>unsuccessful attempts: {countUnsuccessful}</div>
      )}
      {gridNumber > 0 && showUnsuccessful && (
        <MemoryGames
